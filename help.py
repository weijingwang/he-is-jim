...
def showCredits():
	...
	while not done:
		...
		messageText("That means you have to press them all at once.",100,150,20,screen,255,255,255,"ComicSans")
		messageText("There may be a boss somewhere in the game.",100,180,20,screen,255,255,255,"ComicSans")
		messageText("It may not die even after entering lots of keys!",100,210,20,screen,255,255,255,"ComicSans")
